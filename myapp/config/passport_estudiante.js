...
const User = require('../app/models/user_estudiante');
...
passport.use('local-registro_estudiante', new LocalStrategy({
usernameField: 'email',
...
passport.use('local-login_estudiante', new LocalStrategy({
    usernameField: 'email',
    passwordField: 'password',
    passReqToCallback: true
    },
